...
process prodigal_sco_to_zoonotic_rank_metadata {
    ...
    """
    python /home/user/custom_scripts/prodigal_sco_to_zoonotic_rank_metadata.py --input $sco --output ${params.prefix}.metadata.txt
    """
}
...
process zoonotic_rank_run {
    ...
    output:
        path "${params.prefix}*"
    """
    Rscript /home/user/custom_scripts/zoonotic_rank/Scripts/PredictNovel.R fasta $contigs $metadata ${params.prefix}
    """
}